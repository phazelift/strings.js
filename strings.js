...
(function() {
  "use strict";
  var Chars, Strings, Types, asciiStringType, breakIfEqual, changeCase, createForce, emptyNumber, insertSort, literals, mapStringToNumber, noDupAndReverse, sortNoDupAndReverse, testValues, typesPredicates, _,
  ...
  noDupAndReverse = function(array) {
  ...
  sortNoDupAndReverse = function(array, maxLength) {
