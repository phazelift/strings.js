...
describe("isLower( char )", function() {
    ...
    it("should return false if invalid or no arguments are given", function(){
        result= Strings.Chars.isLower();
        expect( result ).toBe( false );

        result= Strings.Chars.isLower( 45 );
        expect( result ).toBe( false );

        result= Strings.Chars.isLower( ['A'] );
        expect( result ).toBe( false );

        result= Strings.Chars.isLower( null );
        expect( result ).toBe( false );

        result= Strings.Chars.isLower( function(){} );
        expect( result ).toBe( false );
    });
    ...
    it("should return false if a valid uppercase character or any other ascii characters is given, checking only the first character", function(){
        ...
        result= Strings.Chars.isLower( '1' );
        expect( result ).toBe( false );

        result= Strings.Chars.isLower( 'Q' );
        expect( result ).toBe( false );

        result= Strings.Chars.isLower( '5' );
        expect( result ).toBe( false );
    ...
    it("should return true if a valid lowercase character is given, checking only the first character", function(){
        ...
        result= Strings.Chars.isLower( 'n' );
        expect( result ).toBe( true );

        result= Strings.Chars.isLower( 'zYX' );
        expect( result ).toBe( true );
    });
...
describe("isAlpha( char )", function() {
    ...
    it("should return false if invalid or no arguments are given", function(){
        result= Strings.Chars.isAlpha();
        expect( result ).toBe( false );

        result= Strings.Chars.isAlpha( 45 );
        expect( result ).toBe( false );

        result= Strings.Chars.isAlpha( ['A'] );
        expect( result ).toBe( false );

        result= Strings.Chars.isAlpha( null );
        expect( result ).toBe( false );

        result= Strings.Chars.isAlpha( function(){} );
        expect( result ).toBe( false );
    });
    ...
    it("should return false if a valid non-alpha character is given, checking only the first character", function(){
        ...
        result= Strings.Chars.isAlpha( '1' );
        expect( result ).toBe( false );
    ...
    it("should return true if a valid alpha-character is given, checking only the first character", function(){
        ...
        result= Strings.Chars.isAlpha( 'n' );
        expect( result ).toBe( true );

        result= Strings.Chars.isAlpha( 'zYX' );
        expect( result ).toBe( true );
    });
...
describe("isNumeric( char )", function() {
    ...
    it("should return false if invalid or no arguments are given", function(){
        result= Strings.Chars.isNumeric();
        expect( result ).toBe( false );

        result= Strings.Chars.isNumeric( '!' );
        expect( result ).toBe( false );

        result= Strings.Chars.isNumeric( ['A'] );
        expect( result ).toBe( false );

        result= Strings.Chars.isNumeric( null );
        expect( result ).toBe( false );

        result= Strings.Chars.isNumeric( function(){} );
        expect( result ).toBe( false );
    });
    ...
    it("should return false if a valid non-numeric ascii character is given, checking only the first character", function(){
        ...
        result= Strings.Chars.isNumeric( '!23' );
        expect( result ).toBe( false );
    });

    it("should return true if a valid numeric ascii character is given, checking only the first character", function(){

        result= Strings.Chars.isNumeric( '1' );
        expect( result ).toBe( true );

        result= Strings.Chars.isNumeric( '0' );
        expect( result ).toBe( true );

        result= Strings.Chars.isNumeric( '5!!' );
        expect( result ).toBe( true );
    });
});
...
describe("isAlphaNumeric( char )", function() {
    ...
    it("should return false if invalid or no arguments are given", function(){
        result= Strings.Chars.isAlphaNumeric();
        expect( result ).toBe( false );

        result= Strings.Chars.isAlphaNumeric( '!' );
        expect( result ).toBe( false );

        result= Strings.Chars.isAlphaNumeric( ['A'] );
        expect( result ).toBe( false );

        result= Strings.Chars.isAlphaNumeric( null );
        expect( result ).toBe( false );

        result= Strings.Chars.isAlphaNumeric( function(){} );
        expect( result ).toBe( false );
    });
    ...
    it("should return true if a valid alpha-numeric ascii character is given, checking only the first character", function(){
        ...
        result= Strings.Chars.isAlphaNumeric( 'Z.?' );
        expect( result ).toBe( true );
    });
...
describe("isSpecial( char )", function() {
    ...
    it("should return false if invalid or no arguments are given", function(){
        result= Strings.Chars.isSpecial();
        expect( result ).toBe( false );

        result= Strings.Chars.isSpecial( NaN );
        expect( result ).toBe( false );

        result= Strings.Chars.isSpecial( ['A'] );
        expect( result ).toBe( false );

        result= Strings.Chars.isSpecial( null );
        expect( result ).toBe( false );

        result= Strings.Chars.isSpecial( function(){} );
        expect( result ).toBe( false );
    });
    ...
    it("should return false if a valid non-special ascii character is given, checking only the first character", function(){
        ...
        result= Strings.Chars.isSpecial( 'z' );
        expect( result ).toBe( false );

        result= Strings.Chars.isSpecial( '0' );
        expect( result ).toBe( false );
    });
    ...
    it("should return true if a valid special ascii character is given, checking only the first character", function(){
        ...
        result= Strings.Chars.isSpecial( '!23' );
        expect( result ).toBe( true );

        result= Strings.Chars.isSpecial( '~bc' );
        expect( result ).toBe( true );
    });
});
